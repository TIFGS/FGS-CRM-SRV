...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const list = yield prealtaActividad_1.default.findAll();
    res.json(list);
});
exports.getAll = getAll;
const getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const resp = yield prealtaActividad_1.default.findByPk(id);
    if (resp) {
        res.json(resp);
    }
    else {
...
const getByIdDoc = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const resp = yield prealtaActividad_1.default.findAll({ where: { prealta_idprealta: id } });
    if (resp) {
        res.json(resp);
    }
    else {
...
const del = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!resp) {
        ...
        yield prealtaActividad_1.default.destroy();
        res.json({
...
const post = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
    yield prealtaActividad_1.default.create(body);
    res.json({
