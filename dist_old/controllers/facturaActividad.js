...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const list = yield facturaActividad_1.default.findAll();
    res.json(list);
});
exports.getAll = getAll;
const getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const resp = yield facturaActividad_1.default.findByPk(id);
    if (resp) {
        res.json(resp);
    }
    else {
...
const getByIdDoc = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const resp = yield facturaActividad_1.default.findAll({ where: { factura_idfactura: id } });
    if (resp) {
        res.json(resp);
    }
    else {
...
const del = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!resp) {
        ...
        yield facturaActividad_1.default.destroy();
        res.json({
...
const post = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
    yield facturaActividad_1.default.create(body);
    res.json({
